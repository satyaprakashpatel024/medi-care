...
public class MedicalRecordController {
     ...
     */
    @GetMapping("/{id}")
    @PreAuthorize("hasRole('HOSPITAL_ADMIN') or @userSecurity.isMedicalRecordOwnerOrDoctor(#id, authentication)")
    ...
    @PreAuthorize("hasAnyRole('HOSPITAL_ADMIN', 'DOCTOR', 'PATIENT')")
